...
def parse_args():
    ...
    p.add_argument("--hold_steps", type=int, default=40,
                   help="Physics steps to hold grasp (actuators active)")
    ...
    p.add_argument("--nfo_min_quality", type=float, default=0.0,
                   help="Minimum NFO quality (0 = disabled, 0.03 = strict)")
    p.add_argument("--vel_threshold", type=float, default=0.3,
                   help="Max object velocity after holding (m/s)")
