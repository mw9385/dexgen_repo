...
def reset_to_random_grasp(
    ...
    if has_exact_pose:
        # Flush object state so obj.data.root_pos_w reflects the write above
        obj = env.scene["object"]
        obj.update(0.0)
        # Derive wrist world pose from DexGraspNet's object_pos_hand/object_quat_hand
    ...
    #    goal object pose in the grasp graph.
    # ------------------------------------------------------------------
